...
def seed_workouts():
    workout1 = Workout(
        user_id=3, route_id=2, title='workout 1 for user 3 route 2', description='test workout 1', image_url='test.url', type='running',
        total_time='40 min', distance='12 miles')
    workout2 = Workout(
        user_id=2, route_id=3, title='workout 2 for user 2 route 3', description='test workout 2', image_url='test.url', type='hiking',
        total_time='1 hour 20 min', distance='8 miles')
    workout3 = Workout(
        user_id=1, route_id=1, title='workout 3 for user 1 route 1', description='test workout 3', image_url='test.url', type='biking',
