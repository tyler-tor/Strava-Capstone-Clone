...
def upgrade():
    ...
    sa.Column('optimize_waypoints', sa.Boolean(True)),
    sa.Column('stopover', sa.Boolean(False)),
    sa.Column('traveling_mode', sa.String(length=50), nullable=False),
    ...
    if environment == "production":
        ...
        op.execute(f"ALTER TABLE routes SET SCHEMA {SCHEMA};")
